  ...
  return (
    <div className="mt-6 border bg-slate-100 rounded-md p-4">
      ...
      {!isEditing && (
        ...
        >
          {initialData.description || t("descriptionForm.inputs-default.description")}
        </p>
      )}
      {isEditing && (
        <Form {...form}>
          ...
          >
                ...
                <FormItem>
                  <FormControl>
                    <Textarea
                      ...
                      placeholder={t(
                        "descriptionForm.inputs-placeholder.description"
                      )}
                      className={cn(
            ...
            <div  className={cn(
              ...
              {isSubmitting ? t("descriptionForm.loading") : t("descriptionForm.submit")}
              </Button>
            </div>
          </form>
        </Form>
